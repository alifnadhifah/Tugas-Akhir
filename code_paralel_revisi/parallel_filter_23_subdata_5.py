...
recommendation_folder3_sd4 = 'E:/TA ALIF/Revisi/new_get_recommendations_r3/sub-data_5'  # Ganti dengan path folder yang sesuai

# Create the directory if it doesn't exist
os.makedirs(recommendation_folder3_sd4, exist_ok=True)

recommender3_sd4 = HybridRecommender3(sub_data_cluster_5, sub_data_rating_5, cosine_sim_5, svd_5, recommendation_folder3_sd4)
query_user_id1_sd4 = sub_data_user_5['User_Id'].sample(n=1).iloc[0]
query_item_id1_sd4 = sub_data_cluster_5['Anime_Id'].sample(n=1).iloc[0]
print(query_user_id1_sd4, query_item_id1_sd4)
top_10_recommendations3_sd4 = recommender3_sd4.get_top_N_recommendations(user_id=query_user_id1_sd4, item_id=query_item_id1_sd4, N=10)
print(top_10_recommendations3_sd4)
...
def getUserRecommendation(user_id):
    ...
    file_path = os.path.join(recommendation_folder3_sd4, file_name)
    ...
    for item_id in sub_data_item_5['Anime_Id']:
        top_10_recommendations = recommender3_sd4.get_top_N_recommendations(user_id=user_id, item_id=item_id, N=10)
...
# avg_precision3_sd4, avg_recall3_sd4, avg_f1_score3_sd4 = recommender3_sd4.evaluate_model(n=10)
# print(f"Avg Precision: {avg_precision3_sd4}, Avg Recall: {avg_recall3_sd4}, Avg F1 Score: {avg_f1_score3_sd4}")
# output_eval = "E:/TA ALIF/Revisi/hasil_evaluasi_baru/sub-data_5/hasil_eval_r3.txt"
# # Create the directory if it doesn't exist
# os.makedirs(os.path.dirname(output_eval), exist_ok=True)
# with open(output_eval, 'w') as f:
#     f.write(f"Avg Precision: {avg_precision3_sd4}, Avg Recall: {avg_recall3_sd4}, Avg F1 Score: {avg_f1_score3_sd4}")