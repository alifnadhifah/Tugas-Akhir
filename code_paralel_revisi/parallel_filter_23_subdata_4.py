...
recommendation_folder3_sd4 = 'E:/TA ALIF/Revisi/new_get_recommendations_r3/sub-data_4'  # Ganti dengan path folder yang sesuai

# Create the directory if it doesn't exist
os.makedirs(recommendation_folder3_sd4, exist_ok=True)

recommender3_sd4 = HybridRecommender3(sub_data_cluster_4, sub_data_rating_4, cosine_sim_4, svd_4, recommendation_folder3_sd4)
query_user_id1_sd4 = sub_data_user_4['User_Id'].sample(n=1).iloc[0]
query_item_id1_sd4 = sub_data_cluster_4['Anime_Id'].sample(n=1).iloc[0]
...
def getUserRecommendation(user_id):
    ...
    for item_id in sub_data_item_4['Anime_Id']:
...
# output_eval = "E:/TA ALIF/Revisi/hasil_evaluasi_baru/sub-data_4/hasil_eval_r3.txt"
# # Create the directory if it doesn't exist
