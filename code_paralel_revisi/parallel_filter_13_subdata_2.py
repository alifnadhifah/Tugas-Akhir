...
recommendation_folder2_sd2 = 'E:/TA ALIF/Revisi/new_get_recommendations_r2/sub-data_2'  # Ganti dengan path folder yang sesuai

# Create the directory if it doesn't exist
os.makedirs(recommendation_folder2_sd2, exist_ok=True)

recommender2_sd2 = HybridRecommender2(sub_data_cluster_2, sub_data_rating_2, svd_2, recommendation_folder2_sd2)
...
def getUserRecommendation(user_id):
    ...
    file_path = os.path.join(recommendation_folder2_sd2, file_name)
    ...
    for item_id in sub_data_cluster_2['Anime_Id']:
        top_10_recommendations = recommender2_sd2.get_top_N_recommendations(user_id=user_id, item_id=item_id, N=10)
...
# avg_precision2_sd2, avg_recall2_sd2, avg_f2_score2_sd2 = recommender2_sd2.evaluate_model(n=10)
# print(f"Avg Precision: {avg_precision2_sd2}, Avg Recall: {avg_recall2_sd2}, Avg F1 Score: {avg_f2_score2_sd2}")
# output_eval = "E:/TA ALIF/Revisi/hasil_evaluasi_baru/sub-data_2/hasil_eval_r2.txt"
# # Create the directory if it doesn't exist
# os.makedirs(os.path.dirname(output_eval), exist_ok=True)
# with open(output_eval, 'w') as f:
#     f.write(f"Avg Precision: {avg_precision2_sd2}, Avg Recall: {avg_recall2_sd2}, Avg F1 Score: {avg_f2_score2_sd2}")